...
class Person:
    ...
    def get_seconds_from_birth(self):
        ...
        #return (actual_time - self.__birth).seconds #funguje i toto
...
class Match:
    def __init__(self, house_player, guest_player):
    ...
    def play(self):
        ...
        if self.hp_points > self.hp_points:
...
match.play()
print(str(match), f'Historie:, {match.get_history()}')
